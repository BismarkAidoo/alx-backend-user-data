...
[0. Et moi et moi et moi!](./api/v1/app.py), [users](api/v1/views/users.py)
...
* Please make sure all mandatory tasks of [this](../0x01-Basic_authentication) previous project are done at `100%` because this project (and the rest of this track) will be based on it.
...
[1. Empty session](./api/v1/auth/session_auth.py), [app](./api/v1/app.py)
